...
public class FlightService {
    ...
    public Flight updateFlight(int flight_id, Flight flight){
        ...
        Flight toBeModified = flightDAO.getFlightById(flight_id);
        toBeModified.setDeparture_city(flight.departure_city);
        toBeModified.setArrival_city(flight.arrival_city);
        return toBeModified;
    }
